...
6. modify the README.md by adding your name to the members list, use this command on terminal :arrow_right: vim README.md, on cmd (for Windows users) :arrow_right: edit README.md
7. Save the changes using :wq on vim , Control-Z for Windows users.
